...
const appPush = {
    ...
    //
    // Все поводы — сообщение менеджера, объявление, ответ клиента по смете, ответ
    // монтажника администрации — сходятся в одном месте: центре сообщений (та же
    // кнопка в шапке). Поэтому разбирать data.open не нужно, достаточно обновить
    // список и открыть его.
    openFor: function () {
        try {
